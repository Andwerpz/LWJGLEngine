...
public class Hitbox {
	...
	public static Texture texture = new Texture("/hitbox.png", null, null, null);
	...
	// returns the result to ray collision after this and input hitbox was translated
...
//		return xInt && yInt && zInt;
		...
		return 	(min.x <= h.max.x && max.x >= h.min.x) && 
				(min.y <= h.max.y && max.y >= h.min.y) && 
	...
	// returns which side the ray intersects this hitbox after the hitbox was translated
