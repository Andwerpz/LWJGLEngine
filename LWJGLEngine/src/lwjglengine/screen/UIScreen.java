...
public class UIScreen extends Screen {
	...
	public void buildBuffers() {
		...
		this.geometryPositionMap = new Texture(this.screenWidth, this.screenHeight, GL_RGBA16F, GL_RGBA, GL_FLOAT);
		this.geometryNormalMap = new Texture(this.screenWidth, this.screenHeight, GL_RGBA16F, GL_RGBA, GL_FLOAT);
		this.geometrySpecularMap = new Texture(this.screenWidth, this.screenHeight, GL_RGBA16F, GL_RGBA, GL_FLOAT);
		this.geometryColorMap = new Texture(this.screenWidth, this.screenHeight, GL_RGBA16F, GL_RGBA, GL_FLOAT);
		...
		this.colorIDMap = new Texture(this.screenWidth, this.screenHeight, GL_RGBA8, GL_RGBA, GL_FLOAT);
