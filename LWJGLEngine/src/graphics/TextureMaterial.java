...
public class TextureMaterial {
	...
	//TODO by default, a rgb-specular material is included with every model instance, set to:
	//diffuse : (1, 1, 1)
	//specular : (1, 1, 1)
	//shininess : (32.0)
	
	//TODO these values are then multiplied with the values supplied in the texture2D sampler to get the final value.
	//note that if you don't change the default rgb-specular material, the texture material should work as expected. 
	
	//TODO if a .mat file includes rgb-specular values, then those are used as default instead. 
